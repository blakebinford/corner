    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=255, validators=[django.core.validators.RegexValidator(message="Invalid format. Use 'implements+HH:MM:SS'.", regex='^\\d+\\+\\d{2}:\\d{2}:\\d{2}$')])),
