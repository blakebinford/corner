...
from competitions.views import SponsorEditView, OrganizerCompetitionsView, ManageCompetitionView, AthleteListView, \
    ...
    CompetitionDisplayView, CompetitionBroadcastView, manual_run_order_edit, ManageCompetitionStaffView, remove_competition_staff
...
urlpatterns = [
    ...
    path('<slug:slug>/', views.CompetitionDetailView.as_view(), name='competition_detail'),
    ...
    path('division/<int:division_id>/weight-classes/', views.get_division_weight_classes,
         name='division_weight_classes'),
    ...
    path('<int:competition_id>/update_score/<int:athlete_competition_id>/<int:event_order_id>/', views.update_score,
         name='update_score'),
    ...
    path('<int:competition_pk>/athlete/<int:athletecompetition_pk>/event/<int:eventorder_pk>/score/',
         views.update_score, name='update_score'),
    path('<int:competition_id>/commentator_compcard/', views.commentator_comp_card, name='commentator_comp_card'),
    path('<int:competition_pk>/upload_sponsor_logos/', views.SponsorLogoUploadView.as_view(),
         name='sponsor_logo_upload'),
    ...
    path('competitions/<int:competition_pk>/edit_weight_classes/', EditWeightClassesView.as_view(),
         name='edit_weight_classes'),
    ...
    path('<int:competition_pk>/toggle_email_notifications/', views.toggle_email_notifications,
         name='toggle_email_notifications'),
    path('competitions/<int:competition_pk>/download_athlete_table/', views.download_athlete_table,
         name='download_athlete_table'),
    path('competitions/<int:competition_pk>/add_athlete/', AddAthleteManuallyView.as_view(), name='add_athlete'),
    path('<int:competition_pk>/create_athlete_profile/', views.AthleteProfileUpdateView.as_view(),
         name='athlete_profile_update'),
    path(
    ...
    path('competitions/<int:competition_pk>/custom-division/add/', CustomDivisionCreateView.as_view(),
         name='add_custom_division'),

    # AthleteCompetition URLs
    path('<int:competition_pk>/register/', views.AthleteCompetitionCreateView.as_view(),
         name='athletecompetition_create'),
    path('athletecompetition/<int:pk>/edit/', views.AthleteCompetitionUpdateView.as_view(),
         name='athletecompetition_update'),
    path('competition/<int:competition_pk>/edit-event-order/', views.EditEventOrderView.as_view(),
         name='edit_event_order'),
    path('athletecompetition/<int:pk>/delete/', views.AthleteCompetitionDeleteView.as_view(),
         name='athletecompetition_delete'),
    ...
    path(
        'competition/<int:competition_pk>/display/',
        CompetitionDisplayView.as_view(),
        name='competition_run_display'
    ),
    ...
    path('competition/<int:competition_pk>/manage/staff/', ManageCompetitionStaffView.as_view(), name='manage_staff'),
    path('competition/<int:competition_pk>/remove-staff/<int:pk>/', remove_competition_staff, name='remove_staff'),
